...
cp -R src/main/module "$working_dir"
rm -rf src
...
echo "Following content has been added to setup.ini file: $setup_ini_content"
...
cd "$working_dir"
rm -rf module
echo "module folder has been removed"
